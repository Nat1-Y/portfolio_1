...
const skillCategories = [
    {
        ...
        type: "Language",
        level: 5,
        capabilities: ["Interactivity & Logic", "Type Safety"],
    },
    {
        id: "PYTHON",
        name: "Python",
        type: "Language",
        level: 5,
        capabilities: ["AI/ML Pipelines", "Automation & Scripting"],
    },
    {
        id: "NODE",
        ...
        type: "Backend",
        level: 5,
        capabilities: ["RESTful APIs", "Event-Driven Architecture"],
    },
    {
        id: "NEST",
        name: "Nest.js",
        type: "Backend",
        level: 5,
        capabilities: ["Scalable Architecture", "Enterprise Solutions"],
    },
    {
        id: "FRONTEND",
        ...
        type: "Framework",
        level: 5,
        capabilities: ["Dynamic Interfaces", "SSR & SSG Optimization"],
    },
    {
        id: "DB",
        ...
        type: "Database",
        level: 5,
        capabilities: ["Relational & NoSQL", "Supabase & Firebase"],
    },
    {
        id: "API",
        name: "REST APIs",
        type: "Interface",
        level: 5,
        capabilities: ["Data Integration", "Secure Endpoints"],
    },
    {
        id: "FLUTTER",
        name: "Flutter",
        type: "Mobile",
        level: 5,
        capabilities: ["Cross-Platform Apps", "Native Performance"],
    },
    {
        id: "DEVOPS",
        name: "Git / CI/CD",
        type: "DevOps",
        level: 5,
        capabilities: ["Version Control", "Automated Pipelines"],
    },
    {
        id: "DOCKER",
        name: "Docker (Basics)",
        type: "Container",
        level: 4,
        capabilities: ["Containerization", "Consistent Environments"],
    },
];
